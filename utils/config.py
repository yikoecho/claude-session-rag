...
# ---- Vector dedup threshold ----
DEDUP_THRESHOLD = float(os.environ.get("DEDUP_THRESHOLD", "0.9"))

# ---- BM25 entity min score ----
# Empirical threshold: entity BM25 hits below this score are not guaranteed a
# result slot (they still compete in the general pool).  Tune for your corpus.
BM25_ENTITY_MIN_SCORE = float(os.environ.get("BM25_ENTITY_MIN_SCORE", "7.0"))
